...
description: E2E testing for React Native apps on iOS and Android using Detox. Write, run, and debug gray-box end-to-end test suites on simulators and emulators. Use when the user mentions "detox", "e2e test", "mobile testing", "react native test", "simulator test", or "emulator test". Handles test setup, writing test suites, configuring .detoxrc.js, mocking, CI integration, and debugging flaky tests.
license: MIT
metadata:
  author: defcode
  version: "1.0.0"
