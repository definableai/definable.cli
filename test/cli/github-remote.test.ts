...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/definable.git")).toEqual({ owner: "sst", repo: "definable" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/definable")).toEqual({ owner: "sst", repo: "definable" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/definable.git")).toEqual({ owner: "sst", repo: "definable" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/definable")).toEqual({ owner: "sst", repo: "definable" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/definable.git")).toEqual({ owner: "sst", repo: "definable" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/definable")).toEqual({ owner: "sst", repo: "definable" })
})
