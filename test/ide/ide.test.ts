...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEFINABLE_CALLER", () => {
    process.env["DEFINABLE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEFINABLE_CALLER", () => {
    process.env["DEFINABLE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEFINABLE_CALLER", () => {
    process.env["DEFINABLE_CALLER"] = "unknown"
